...
function decodeArrayBuffer(input): ArrayBuffer {
...
function decodeBase64ToArrayBuffer(input: string, arrayBuffer: ArrayBuffer): Uint8Array {
...
export function FromBase64ToArrayBuffer(base64: string) : ArrayBuffer {
