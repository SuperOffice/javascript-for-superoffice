...
var entities = ['Contact', 'Person', 'Sale'];
...
var generateImportStatements = function () {
    return "import { ".concat(entities.map(function (e) { return "".concat(e, "Entity"); }).join(', '), " } from \"@superoffice/tsclient.webapi/dist/Carriers\";");
};
var generateExport = function () { return "\nexport const RTL = {\n    ".concat(entities.map(function (entity) { return "".concat(entity, "Agent: Extended").concat(entity, "Agent"); }).join(',\n    '), "\n};\n"); };
